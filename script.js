...
function getScreen() {
    ...
    if (style != undefined) {
        ...
        if (Object.hasOwn(style, "all")) {
            ...
            document.getElementById("playScreen").style.font = Object.hasOwn(style.all, "font") ? style.all.font : "";
        ...
        if (Object.hasOwn(style, "header")) {
            ...
            document.getElementById("header").style.font = Object.hasOwn(style.header, "font") ? style.header.font : "";
        ...
        if (Object.hasOwn(style, "text")) {
            ...
            document.getElementById("text").style.font = Object.hasOwn(style.text, "font") ? style.text.font : "";
        ...
        if (Object.hasOwn(style, "choices")) {
            ...
            document.getElementById("inputOptions").style.font = Object.hasOwn(style.choices, "font") ? style.choices.font : "";
